...
# Intentar "corregir" la coordenada real (esto generará error - demostración)
...
# Tupla de tuplas: Patrón completo de barrenos
patron_banco = (
...
for i in range(len(sondajes)):
    ...
    # Determinar estado basado en ley
    if ley >= 2.0:
        estado = "Mineral Alto"
    elif ley >= 1.0:
        estado = "Mineral Bajo"
